            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        {/* App Window Mockup */}
                        <div className="relative w-full max-w-[650px] rounded-2xl overflow-hidden border border-white/10 bg-[#1e1e2e] shadow-2xl ring-1 ring-white/10">
                            {/* Window Header */}
                            ...
                            {/* Image Placeholder */}
                            <img
                                src="/images/canchas/hero-mockup.png"
                                alt="Dashboard Mi Partido Desktop"
                                className="w-full h-auto object-cover min-h-[350px] bg-[#1e1e2e]"
                                onError={(e) => {
                                    // Fallback UI if image isn't available yet
                            ...
                            <div className="hidden absolute inset-0 top-8 flex">
                        ...
                        <motion.div 
                            ...
                            className="absolute -bottom-6 -left-6 bg-card border border-border p-4 rounded-xl shadow-xl flex items-center gap-4 hidden sm:flex"
                        >
                            <div className="w-12 h-12 rounded-full bg-green-500/10 flex items-center justify-center text-green-500">
                                <span className="font-bold text-xl">24</span>
                            </div>
                            <div>
                                <p className="text-sm font-bold text-foreground">Turnos hoy</p>
                                <p className="text-xs text-muted-foreground">Agenda completa</p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div 
                            ...
                            className="absolute top-12 -right-6 bg-card border border-border px-4 py-2 rounded-lg shadow-xl flex items-center gap-2 hidden lg:flex"
                        >
                            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                            <span className="text-sm font-bold text-foreground">Caja Abierta</span>
                        </motion.div>
                    </motion.div>
                </div>
            </div>
